...
class Settings(BaseSettings):
    ...
    openai_planner_model: str = Field(default="gpt-4o-mini", alias="OPENAI_PLANNER_MODEL")
    openai_complex_planner_model: Optional[str] = Field(default=None, alias="OPENAI_COMPLEX_PLANNER_MODEL")
    ...
    ai_chat_history_prompt_messages: int = Field(default=4, alias="AI_CHAT_HISTORY_PROMPT_MESSAGES")
    ai_chat_history_message_chars: int = Field(default=700, alias="AI_CHAT_HISTORY_MESSAGE_CHARS")
    ai_conversation_reference_messages: int = Field(default=6, alias="AI_CONVERSATION_REFERENCE_MESSAGES")
    ai_schema_prompt_max_chars: int = Field(default=45000, alias="AI_SCHEMA_PROMPT_MAX_CHARS")
    ai_tool_result_prompt_max_chars: int = Field(default=25000, alias="AI_TOOL_RESULT_PROMPT_MAX_CHARS")
    ai_enable_cost_logging: bool = Field(default=True, alias="AI_ENABLE_COST_LOGGING")
